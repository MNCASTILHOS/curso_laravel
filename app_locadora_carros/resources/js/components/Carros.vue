<template>
    <div class="container">
                ...
                <card-component titulo="Busca de carros">
                    <template v-slot:conteudo>
                        <div class="form-row">
                            ...
                            <div class="col mb-3">
                                <input-container-component titulo="Nome do carro" id="inputNome" id-help="nomeHelp" texto-ajuda="Opcional. Informe o nome da carro">
                                    <input type="text" class="form-control" id="inputNome" aria-describedby="nomeHelp" placeholder="Nome o carro" v-model="busca.nome">
                                </input-container-component>
                            </div>
                        </div>
                    </template>
        ...
        <!-- início do modal de inclusão de carros -->
        <modal-component id="modalCarro" titulo="Adicionar carro">
            ...
            <template v-slot:conteudo>
                <div class="form-group">
                    <input-container-component titulo="Nome do carro" id="novoNome" id-help="novoNomeHelp" texto-ajuda="Informe o nome do carro">
                        <input type="text" class="form-control" id="novoNome" aria-describedby="novoNomeHelp" placeholder="Nome do carro" v-model="nomeCarro">
                    </input-container-component>
                    {{ nomeCarro }}
                </div>
